      ...
      >
        <div className="w-full max-w-md">
          <motion.div
            ...
            style={{
              background: isDark
                ? 'linear-gradient(145deg, rgba(16, 185, 129, 0.15) 0%, rgba(0, 85, 255, 0.1) 100%)'
                : 'linear-gradient(145deg, rgba(16, 185, 129, 0.1) 0%, rgba(0, 85, 255, 0.05) 100%)',
          ...
          >
            <motion.div className="relative mb-8">
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="absolute inset-0 w-20 h-20 mx-auto rounded-full bg-green-500/20"
              />
              <motion.div
                variants={iconVariants}
                className="relative w-20 h-20 mx-auto rounded-full bg-green-500/20 flex items-center justify-center"
              >
            ...
            <motion.div variants={itemVariants} className="mb-8">
              ...
              <p className={clsx(
                ...
                You've successfully signed in to {botName}
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-3">
              <motion.button
                ...
                className="w-full inline-flex items-center justify-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-all duration-200"
            ...
            <div
              ...
              style={{ background: 'linear-gradient(90deg, rgba(16, 185, 129, 0) 0%, rgb(16, 185, 129) 50%, rgba(16, 185, 129, 0) 100%)' }}
            />
          </motion.div>
        </div>
      </motion.div>
